...
// const SERVER_ROUTE = env.SERVER_ROUTE
...
message.addEventListener('keydown', function(e){
  if (e.key.length === 1) {
    ...
    timeout = setTimeout(function() {
      ...
      let request_message = message.textContent
      let request_tone = tone.value
      const request_data = {request_message, request_tone}
      let request_options = {
        method: 'POST',
        headers: {
      ...
      fetch(SERVER_ROUTE + '/autocomplete', request_options)
